...
import com.util.CustomFloatDeserializer;
...
@Setter
@JsonPropertyOrder({
    "realtime_start", "realtime_end", "date", "value", "id", "title",
...
public class EtlColumnPojo {
    ...
    public String getValues(){
        String values = realtime_start + "," + realtime_end + "," + date + "," + value + "," + id + "," +  title + "," + 
                        state + "," + frequency_short + "," + units_short + "," + seasonal_adjustment_short;
        return values;
    }
    ...
    public String getColumns() {
        return "realtime_start,realtime_end,date,value,id,title,state,frequency_short,units_short,seasonal_adjustment_short";
    }
